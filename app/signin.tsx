...
const styles = StyleSheet.create({
  ...
  configTitle: { fontSize: 14, fontWeight: '700', color: '#7A6000' },
  configBody: { fontSize: 13, color: '#7A6000', lineHeight: 18 },
  configCode: { fontSize: 11, fontFamily: 'monospace', color: '#4A3800', lineHeight: 18 },
