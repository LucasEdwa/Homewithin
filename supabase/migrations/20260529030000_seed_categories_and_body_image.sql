-- Repair: inserts that were skipped when 20260529020000 errored on the duplicate policy.
-- The resource_categories table and RLS policy already exist in the remote DB.
